    ...
    <footer className="w-full p-10 border-t border-slate-200/50">
      <div className="mx-auto px-4 sm:px-6 lg:px-0">
        <div className="w-full mx-auto">
          ...
          <ul className="text-lg flex items-center justify-center flex-col gap-4 md:gap-12 md:flex-row transition-all duration-500 py-16 ">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-12 justify-center items-center mb-16 md:mb-10">
            <a
              target="_blank"
